...
简体中文汉化版 TeslaMate Grafana Dashboard - 开箱即用 | 36个仪表板 100% 汉化 | 支持 Docker 一键部署
...
- ✅ **完全汉化** - 36个 Dashboard，含5个全新原创分析图表
...
| 充电相关 | 11 | 31% | 充电监控、成本、电池健康、哨兵耗电 |
| 驾驶相关 | 9 | 25% | 行程记录、轨迹、规律分析、年度报告 |
| 车辆状态 | 6 | 17% | 实时状态、胎压、能效 |
| 其他功能 | 6 | 17% | 地图、时间线、省钱分析 |
| **总计** | **36** | **100%** | **全方位车辆数据分析** |
