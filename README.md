...
- 🆕 **驾驶评分** — 四维度综合评分系统，参考行业标准（Damoov/Sentiance）设计
  - **效率分（30%）**：理想续航消耗比，反映节能驾驶习惯
  - **平稳分（30%）**：急加速（>60kW）+ 急刹车（<-30kW）时间占比，positions 表精准计算
  - **速度分（20%）**：超速（>130km/h）采样点占比
  - **回收分（20%）**：回收能量 ÷ 消耗能量比值，反映单踏板驾驶习惯
  - 驾驶风格自动判定：节能达人 / 稳健驾驶 / 普通驾驶 / 偏激进 / 激进驾驶
  - 综合评分趋势折线图（含五条维度曲线）
  - 行程评分明细表（含彩色评分列）
