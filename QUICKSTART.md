...
| **PostgreSQL 18** | 与官方 teslamate-org 对齐（`postgres:18-trixie`）。simple-deploy.sh 默认装 PG 18；从老 TeslaMate 迁来如在 PG 14/15/16/17，需先按 [TROUBLESHOOTING「PostgreSQL 大版本升级」](TROUBLESHOOTING.md#postgresql-大版本升级如-17--18) 备份升级 |
